...
public class HtmlToTableExampleService {
//        public static void main(String[] args) {
//        new HtmlToTableExampleService().run();
//    }
    ...
    @Value("${google.site.keyFileLocation}")
    public void setKeyFileLocation(String keyFileLocation) {KEY_FILE_LOCATION = keyFileLocation;}

    // 빈 문서를 활용, 빈 문서의 경로
    public static final String hwpBlankPath = "C:"+ File.separator +"Users"+ File.separator +"tenth"+ File.separator +"Downloads"+ File.separator +"hwpLab.hwp";

    // 저장할 파일 경로
    public static final String hwpOutputPath = "C:"+ File.separator +"Users"+ File.separator +"tenth"+ File.separator +"Downloads";
    ...
    public void activeUserReport( ) throws Exception {
        ...
        try {
            ...
            System.out.println(hwpFile);
            String html = new String(Files.readAllBytes(Paths.get("C:/Users/tenth/Documents/workspace/asopLab/demo/build/resources/main/tableExample.html")));
...
//        FileInputStream file =  new FileInputStream(resource.getFile());
//
//        hwpFile = HWPReader.fromFile(file.toString());
//        // hwpFile = HWPReader.fromFile(hwpBlankPath);
//        String html = new String(Files.readAllBytes(Paths.get("sample_hwp" + File.separator + "tableExample.html")));
//
//        // 불러온 HTML을 Jsoup로 변환합니다. 이는 각 Element를 조사하고, 어떤 텍스트가 들었는지,
//        // 합쳐진 열이나 행이 있는지 알기 위함입니다.
//        Document doc = Jsoup.parse(html);
